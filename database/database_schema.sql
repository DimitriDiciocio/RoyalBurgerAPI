...
CREATE TABLE FINANCIAL_MOVEMENTS (
	...
	CONSTRAINT CHK_FINANCIAL_MOVEMENTS_TYPE CHECK (TYPE IN ('REVENUE', 'EXPENSE', 'CMV', 'TAX')),
	CONSTRAINT CHK_FINANCIAL_MOVEMENTS_STATUS CHECK (PAYMENT_STATUS IN ('Pending', 'Paid')),
	CONSTRAINT CHK_FINANCIAL_MOVEMENTS_VALUE CHECK ("VALUE" > 0)
);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_TYPE ON FINANCIAL_MOVEMENTS (TYPE);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_STATUS ON FINANCIAL_MOVEMENTS (PAYMENT_STATUS);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_MOVEMENT_DATE ON FINANCIAL_MOVEMENTS (MOVEMENT_DATE);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_CATEGORY ON FINANCIAL_MOVEMENTS (CATEGORY);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_RELATED ON FINANCIAL_MOVEMENTS (RELATED_ENTITY_TYPE, RELATED_ENTITY_ID);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_CREATED_AT ON FINANCIAL_MOVEMENTS (CREATED_AT DESC);
CREATE INDEX FK_FINANCIAL_MOVEMENTS_USER ON FINANCIAL_MOVEMENTS (CREATED_BY);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_GATEWAY ON FINANCIAL_MOVEMENTS (PAYMENT_GATEWAY_ID);
CREATE INDEX IDX_FINANCIAL_MOVEMENTS_TRANSACTION ON FINANCIAL_MOVEMENTS (TRANSACTION_ID);
