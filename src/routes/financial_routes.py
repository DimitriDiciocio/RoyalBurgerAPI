# src/routes/financial_routes.py
...
# GET /financials/summary -> KPIs financeiros
...
# GET /financials/transactions -> Lista transações financeiras
...
# POST /financials/transactions -> Cria nova transação financeira
